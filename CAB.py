...
#arg.add_argument( '--video', type = str, default = '', help = 'Video file path. If no path is given, video is captured using device.')

arg.add_argument( '--model', required = True, help = "Path to the pretrained model.")

arg.add_argument( '--prototxt', required = True, help = 'Prototxt of the model.')

arg.add_argument( '--labels', required = True, help = 'Labels of the dataset.')

arg.add_argument( '--confidence', type = float, default = 0.2, help='Set confidence for detecting objects')
